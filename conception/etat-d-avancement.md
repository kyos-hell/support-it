...
9. **`0.3.1` le 2026-09-23 — le point d'entrée en portée projet**
   ...
   est-il celui de la session ?). Fusionnée dans `v0.4.0` le jour même :
   **prérequis de la porte 2** — M10 et M11 ne tiennent que dans le
   dossier (M12 du plan 0.4.0).
